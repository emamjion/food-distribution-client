...
const SuppliesSection = () => {
    ...
    useEffect(() => {
        fetch('https://food-distribution-supplies-server.vercel.app/supplies')
        .then(res => res.json())
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                {
                    ...
                    >
                        <img src={supply.image} className="w-full rounded-md scale-95 hover:scale-100 duration-500" />
                        ...
                        <div className="flex items-center justify-center my-4">
                            <button className='scale-95 hover:scale-100 duration-500 px-4 py-2.5 text-white bg-[#212121] font-medium rounded-lg'>View Details</button>
                        </div>
                    </div>))
                }
            </div>
